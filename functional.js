...
//function fullAddress(element) {
    //return element.map(element => "https://example.com/" + urlify(element));
//}
...
//function containsTwoWords(elements) {
    //return elements.filter(element => element.split(/\s+/).length === 2);
//}
//console.log(containsTwoWords(states));
